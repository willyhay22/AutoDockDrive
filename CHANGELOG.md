...
### Fixed
- **Intel Mac Support:** Fixed a compilation issue that prevented the app from opening on Intel-based Macs.
- **Homebrew Installation:** Updated the Homebrew tap to resolve download 404 errors.
